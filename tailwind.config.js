  ...
  theme: {
    extend: {
      fontFamily: {
        ...
        'roboto': ['Roboto', 'ui-sans-serif', 'system-ui', '-apple-system', 'Segoe UI', 'Roboto', 'Helvetica', 'Arial'],
        'sans': ['Open Sans', 'ui-sans-serif', 'system-ui', '-apple-system', 'Segoe UI', 'Roboto', 'Helvetica', 'Arial'],
      },
      colors: {
        primary: '#1E3A8A',
        secondary: '#4B5EAA',
