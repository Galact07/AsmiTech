          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-slate-700/80 mb-4">
                Our SAP Document and Reporting Compliance services help you maintain regulatory compliance while simplifying 
                your invoicing, reporting, and documentation processes. We ensure your SAP system meets all legal requirements.
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-slate-700/80">Automate invoicing and reporting to reduce errors and delays</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700/80">Ensure compliance with local and international regulations</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700/80">Provide audit-ready documentation and reporting capabilities</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700/80">Real-time validation of documents against compliance rules</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700/80">Streamlined e-invoicing processes for faster payments</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="flex justify-center">
            <div className="text-center max-w-2xl">
              <h2 id="cta" className="text-3xl md:text-4xl font-bold tracking-tight">
                Need compliant SAP document processing?
              </h2>
              <p className="mt-4 text-slate-600 max-w-2xl">
                Let's ensure your SAP system meets all compliance requirements.
              </p>
...
export default SapDocumentAndReportingCompliance;
