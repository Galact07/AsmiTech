          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-slate-700/80 mb-4">
                Our Support & Managed Services ensure your SAP system runs smoothly 24/7. We provide proactive monitoring, 
                issue resolution, system optimization, and continuous improvement to keep your SAP environment at peak performance.
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-slate-700/80">24/7 monitoring and issue resolution to avoid disruptions</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700/80">System optimization to maintain efficiency and reliability</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700/80">Regular updates, patches, and preventive maintenance</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700/80">Rapid response times for critical issues</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700/80">Ongoing performance tuning and capacity planning</span>
                </li>
              </ul>
            </div>
          </div>
