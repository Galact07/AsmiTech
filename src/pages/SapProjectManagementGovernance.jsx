...
import { ArrowUpRight, Clipboard, CheckCircle } from 'lucide-react';

const SapProjectManagementGovernance = () => {
  return (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-slate-700/80 mb-4">
                Our SAP Project Management & Governance services ensure your SAP initiatives are delivered on time, 
                within budget, and with the highest quality. We provide comprehensive project oversight and governance frameworks.
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-slate-700/80">Clear project planning, timelines, and milestone tracking</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700/80">Risk management and mitigation throughout the project lifecycle</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700/80">Stakeholder communication and reporting for transparency and accountability</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700/80">Quality assurance and testing coordination</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700/80">Resource management and allocation</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="flex justify-center">
            <div className="text-center max-w-2xl">
              ...
              <p className="mt-4 text-slate-600 max-w-2xl">
                Let's ensure your project is delivered successfully with expert governance.
              </p>
...
export default SapProjectManagementGovernance;
