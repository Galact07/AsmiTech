...
import { ArrowUpRight, Settings, CheckCircle } from 'lucide-react';

const SapImplementationsAndRollouts = () => {
  return (
          ...
          <div className="sm:p-8 md:p-12 pt-0 pr-6 pb-6 pl-6">
            <div className="flex items-start md:items-center gap-6 md:gap-10 flex-col md:flex-row">
              <div className="flex-1">
                ...
                <h1 id="service-title" className="sm:text-4xl md:text-5xl text-3xl font-bold text-slate-700 tracking-tight mt-2 leading-tight md:leading-tight break-words">
                  <span className="md:block">SAP <span className="md:hidden">Implement-<br />ations</span><span className="hidden md:inline">Implementations</span> and Rollouts</span>
                </h1>
                ...
                <div className="mt-6 flex flex-col sm:flex-row gap-3">
                  <Link
                    to="/contact"
                    className="group inline-flex items-center justify-center gap-2 hover:brightness-110 transition text-sm font-bold text-slate-50 bg-primary border-slate-200 border rounded-none px-5 py-3 focus:outline-none"
                  >
                    Get Started
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-slate-700/80 mb-4">
                We specialize in comprehensive SAP implementations and rollouts, from initial planning to successful deployment. 
                Our experienced team ensures your SAP system is configured to match your specific business processes and requirements.
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-slate-700/80">Full lifecycle management from planning to go-live</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700/80">Customization to match specific business processes and reporting requirements</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700/80">Risk mitigation and quality assurance throughout the deployment</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700/80">Proven methodologies: Greenfield, Brownfield, and Bluefield approaches</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700/80">Minimal disruption to business operations during implementation</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="flex justify-center">
            <div className="text-center max-w-2xl">
              ...
              <p className="mt-4 text-slate-600 max-w-2xl">
                Let's discuss how we can successfully deploy SAP for your organization.
              </p>
...
export default SapImplementationsAndRollouts;
